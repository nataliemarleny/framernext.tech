      ...
      <IndexGrid alignItems="start">
        <IndexGrid.Item mb={3}>
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="https://www.framer.com/loupe/"
          >
          ...
          <ButtonFillDark
            ...
            mb={3}
            mr={2}
            href="https://github.com/nataliemarleny/framernext.tech"
          >
            <StyledOcticon
              icon={MarkGithub}
              size={20}
        ...
        <IndexGrid.Item>
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="https://twitter.com/nataliemarleny"
          >
            <StyledOcticon
              icon={TwitterIcon}
              size={20}
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="https://github.com/nataliemarleny"
          >
            <StyledOcticon
              icon={MarkGithub}
              size={20}
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="codesandbox.io/u/nataliemarleny"
          >
            <StyledOcticon
              icon={CodeSandboxIcon}
              size={20}
          ...
          <LinkDark
            ...
            mb={3}
            display="block"
            href="https://medium.com/@nataliemarleny"
          >
            <StyledOcticon
              icon={MediumIcon}
              size={20}
