      ...
      <Box bg="white" color="black" px={4} py={12}>
        <Box className="container-xl" px={2}>
          ...
          <Flex flexWrap="wrap" mr={[0, 0, -gutter]}>
            ...
            >
              A set of properties and helpers for high-performance, declarative
              animations.
            </Promo>
            <Promo
              title="Animate/Loop"
            ...
            >
              Here, we’re setting the loop property to Infinity, and the ease to
              linear, for a perfectly looping animation.
            </Promo>
            <Promo
              title="Animate/Cycle"
              image={AnimateCycle}
            ...
            >
              You can cycle through animations with the useCycle method from
              Framer.
            </Promo>
            <Promo
              title="Animate/Color"
            ...
            >
              Color strings can also be animated by using the background
              property.
            </Promo>
            <Promo
            ...
            >
              Next to single values, you can also animate arrays of values
              within the animate property.
            </Promo>
            <Promo
              title="Gestures"
            ...
            >
              Start by animating a Frame when tapping on it. Then create two
              constants, a default rotate value of 0 and a setState method.
            </Promo>
            <Promo
              title="On Hover"
              image={OnHover}
            ...
            >
              Scale down a Frame when hovering it. Use the whileHover property,
              and pass along a property as its value.
            </Promo>
            <Promo
            ...
            >
              For scrolling, you can wrap Frames in a Scroll component, to make
              them automatically scrollable.
            </Promo>
            <Promo
              title="Paging"
              image={Paging}
            ...
            >
              For paging, you can wrap Frames in a Page component to make them
              swipeable.
            </Promo>
            <Promo
              title="Transforms"
            ...
            >
              Here, we’re using two custom Hooks in Framer to transform values
            ...
            >
              Variants are collections of visual properties, like states, that
              you can animate or cycle between.
            </Promo>
          </Flex>
        </Box>
      </Box>
...
const Promo = ({
  ...
  <Box
    ...
    {...rest}
  >
    <A href={href} ariaLabel={ariaLabel} display="block" mb={1}>
      <BorderBox
        as={Image}
        bg="black"
        border={0}
